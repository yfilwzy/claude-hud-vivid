import { yellow, green, magenta, cyan, dim, segment } from './colors.js';
...
function renderMainAgentLine(ctx, todoStyle, useVivid, palette) {
    ...
    if (taskPart)
        parts.push(dim(taskPart));
    return parts.join(' │ ');
}
function formatAgent(agent, bindings, useVivid, palette) {
